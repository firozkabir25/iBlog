                        ...
                        <div class="py-2">
                            <div class="relative desktop-dropdown-sub">
                                ...
                                <div class="absolute left-full top-0 mt-0 w-64 bg-white rounded-md shadow-lg hidden desktop-dropdown-submenu">
                                    <a href="{{route('category.web-development')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition">Frontend</a>
                                    <a href="{{route('category.web-development')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition">Backend</a>
                                    <a href="{{route('category.web-development')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition">Full Stack</a>
                                </div>
                            </div>
                            <div class="relative desktop-dropdown-sub">
                                <button class="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition flex justify-between items-center w-full text-left">
